...
class John(models.Model):
    ...
    class Meta:
        managed = True
        db_table = 'nearbyshops_john'


class Review(models.Model):
    user = models.ForeignKey("AuthUser", on_delete=models.CASCADE, related_name="reviewer")
    john = models.ForeignKey("John", on_delete=models.CASCADE, related_name="john_location")
    review_text = models.TextField(max_length=180, blank=True, null=True)
    review_title = models.TextField(max_length=60, blank=True, null=True)
